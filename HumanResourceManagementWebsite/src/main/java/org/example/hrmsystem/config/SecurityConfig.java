    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        /* RBAC: chặn EMPLOYEE ở tầng filter (Postman + browser), MANAGER/ADMIN/HR xử lý scope trong service */
                        ...
                        .requestMatchers("/api/performance-reviews/**").hasAnyRole("ADMIN", "HR", "MANAGER")
